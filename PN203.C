...
static int x[15]={ 370, 370, 370, 370, 397, 431, 465, 499, 533, 533, 533, 499, 465, 431, 397 };
static int y[15]={ 77,  102, 127, 152, 176, 176, 176, 176, 176, 210, 244, 244, 244, 244, 244 };
static int s;

//void fill_block(int x,int y);
   ...
   for(i=0; i<7; i++)
   {
	...
	if( i%2==0 )
	 ...
	 three();
	  ...
	  delay(600);  //  Rolling Pattern Speed Control
