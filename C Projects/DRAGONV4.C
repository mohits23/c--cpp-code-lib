		   // Transition: 1   #Modified Controls
   ...
   clrscr();
    ...
    settextstyle(TRIPLEX_FONT, HORIZ_DIR, 1);
     ...
     outtextxy(130,290,"(#) Feel Free To Exit The Game Anytime...Press 'ESC'.");
       setcolor(5);
    outtextxy(50,340,"($) Press Any key To Escape The 'Help-Screen'.");
       setcolor(BLACK);
     outtextxy(100,370,"Copyright@2020    Developed By : Mohit Singh.");
      ch=getch();
      temp=ch;
       if( temp==27 )
       {
