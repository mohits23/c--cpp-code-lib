...
void pause();
void help();
void clearpixel_horiz(int,int,int,int);
void clearpixel_vert(int,int,int,int);
...
void help()
{
   ...
   clrscr();
    ...
    settextstyle(TRIPLEX_FONT, HORIZ_DIR, 1);
      setcolor(RED);
     outtextxy(170,100,"(*) 'W' --> Up");
     outtextxy(170,130,"(*) 'S' --> Down");
     outtextxy(170,160,"(*) 'A' --> Left");
     outtextxy(170,190,"(*) 'D' --> Right");
      setcolor(GREEN);
...
void clearpixel_horiz(int x1,int y1,int x2,int y2)
{
   int xc,yc,i;
    xc=abs(x2-x1);
    yc=abs(y2-y1);
...
void clearpixel_vert(int x1,int y1,int x2,int y2)
{
   int xc,yc,i;
    xc=abs(x2-x1);
    yc=abs(y2-y1);
